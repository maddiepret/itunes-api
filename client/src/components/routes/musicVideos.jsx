...
import musicVideoImg from '../images/musicVideo-img.jpg'
 ...
 class musicVideos extends Component {
    ...
    //set state
      ...
      componentWillMount = ( query) => {
        const searchUrl = `/musicVideo/${query}`;
      ...
      console.log(favoriteList);
        return (
            ...
            <div className="heading">
                <img className="movie-img" src={musicVideoImg} alt="music Video"/>
                <h1>Music Video</h1><h2>Let the music take you away</h2>
            </div>
